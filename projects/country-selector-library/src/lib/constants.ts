...
export const COUNTRIES_LIST: ICountry[] = [
  ...
  {
    name: 'Mauritania', localName: '‫موريتانيا‬‎',
    code: 'MR',
    capital: 'Nouakchott',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Mauritius', localName: 'Moris',
    code: 'MU',
    capital: 'Port Louis',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Micronesia', localName: 'Federated States of',
    code: 'FM',
    capital: 'Palikir',
    region: 'OC',
    currency: {
  ...
  {
    name: 'Moldova', localName: 'Republica Moldova',
    code: 'MD',
    capital: 'Chișinău',
    region: 'EU',
    currency: {
  ...
  {
    name: 'Mongolia', localName: 'Монгол',
    code: 'MN',
    capital: 'Ulan Bator',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Montenegro', localName: 'Crna Gora',
    code: 'ME',
    capital: 'Podgorica',
    region: 'EU',
    currency: {
  ...
  {
    name: 'Mozambique', localName: 'Moçambique',
    code: 'MZ',
    capital: 'Maputo',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Myanmar', localName: 'Burma) (မြန်မာ',
    code: 'MM',
    capital: 'Naypyidaw',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Namibia', localName: 'Namibië',
    code: 'NA',
    capital: 'Windhoek',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Netherlands', localName: 'Nederland',
    code: 'NL',
    capital: 'Amsterdam',
    region: 'EU',
    currency: {
  ...
  {
    name: 'New Caledonia', localName: 'Nouvelle-Calédonie',
    code: 'NC',
    capital: 'Nouméa',
    region: 'OC',
    currency: {
  ...
  {
    name: 'North Korea', localName: '조선 민주주의 인민 공화국',
    code: 'KP',
    capital: 'Pyongyang',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Northern Mariana Islands', localName: '',
    code: 'MP',
    capital: 'Saipan',
    region: 'OC',
    currency: {
  ...
  {
    name: 'Pakistan', localName: '‫پاکستان‬‎',
    code: 'PK',
    capital: 'Islamabad',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Palestine', localName: '‫فلسطين‬‎',
    code: 'PS',
    capital: 'Ramallah',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Papua New Guinea', localName: '',
    code: 'PG',
  ...
  {
    name: 'Republic of Kosovo', localName: '',
    code: 'XK',
    capital: 'Pristina',
    region: 'EU',
    currency: {
  ...
  {
    name: 'Réunion', localName: 'La Réunion',
    code: 'RE',
    capital: 'Saint-Denis',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Romania', localName: 'România',
    code: 'RO',
    capital: 'Bucharest',
    region: 'EU',
    currency: {
  ...
  {
    name: 'Saint Martin', localName: 'Saint-Martin (partie française)',
    code: 'BL',
    capital: 'Gustavia',
    region: 'NA',
    currency: {
  ...
  {
    name: 'Saint Helena, Ascension and Tristan da Cunha', localName: '',
    code: 'SH',
    capital: 'Jamestown',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Saint Kitts and Nevis', localName: '',
    code: 'KN',
    capital: 'Basseterre',
    region: 'NA',
    currency: {
  ...
  {
    name: 'Saint Martin', localName: 'French part',
    code: 'MF',
    capital: 'Marigot',
    region: 'NA',
    currency: {
  ...
  {
    name: 'Saint Pierre and Miquelon', localName: '',
    code: 'PM',
  ...
  {
    name: 'Saint Vincent and the Grenadines', localName: '',
    code: 'VC',
    capital: 'Kingstown',
    region: 'NA',
    currency: {
  ...
  {
    name: 'São Tomé and Príncipe', localName: 'São Tomé e Príncipe',
    code: 'ST',
    capital: 'São Tomé',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Saudi Arabia', localName: '‫المملكة العربية السعودية‬‎',
    code: 'SA',
    capital: 'Riyadh',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Senegal', localName: 'Sénégal',
    code: 'SN',
    capital: 'Dakar',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Slovakia', localName: 'Slovensko',
    code: 'SK',
    capital: 'Bratislava',
    region: 'EU',
    currency: {
  ...
  {
    name: 'Slovenia', localName: 'Slovenija',
    code: 'SI',
    capital: 'Ljubljana',
    region: 'EU',
    currency: {
  ...
  {
    name: 'Solomon Islands', localName: '',
    code: 'SB',
    capital: 'Honiara',
    region: 'OC',
    currency: {
  ...
  {
    name: 'Somalia', localName: 'Soomaaliya',
    code: 'SO',
    capital: 'Mogadishu',
    region: 'AF',
    currency: {
  ...
  {
    name: 'South Korea', localName: '대한민국',
    code: 'KR',
    capital: 'Seoul',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Sri Lanka', localName: 'ශ්‍රී ලංකාව',
    code: 'LK',
    capital: 'Colombo',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Switzerland', localName: 'Schweiz',
    code: 'CH',
    capital: 'Bern',
    region: 'EU',
    currency: {
  ...
  {
    name: 'Tanzania, United Republic of', localName: '',
    code: 'TZ',
    capital: 'Dodoma',
    region: 'AF',
    currency: {
  ...
  {
    name: 'Trinidad and Tobago', localName: '',
    code: 'TT',
  ...
  {
    name: 'Turks and Caicos Islands', localName: '',
    code: 'TC',
  ...
  {
    name: 'Ukraine', localName: 'Україна',
    code: 'UA',
    capital: 'Kyiv',
    region: 'EU',
    currency: {
  ...
  {
    name: 'United Arab Emirates', localName: '‫الإمارات العربية المتحدة‬‎',
    code: 'AE',
    capital: 'Abu Dhabi',
    region: 'AS',
    currency: {
  ...
  {
    name: 'United Kingdom of Great Britain and Northern Ireland', localName: '',
    code: 'GB',
    capital: 'London',
    region: 'EU',
    currency: {
  ...
  {
    name: 'United States of America', localName: '',
    code: 'US',
  ...
  {
    name: 'Uzbekistan', localName: 'Oʻzbekiston',
    code: 'UZ',
    capital: 'Tashkent',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Venezuela', localName: 'Bolivarian Republic of',
    code: 'VE',
    capital: 'Caracas',
    region: 'SA',
    currency: {
  ...
  {
    name: 'Vietnam', localName: 'Việt Nam',
    code: 'VN',
    capital: 'Hanoi',
    region: 'AS',
    currency: {
  ...
  {
    name: 'Wallis and Futuna', localName: 'Wallis-et-Futuna',
    code: 'WF',
    capital: 'Mata-Utu',
    region: 'OC',
    currency: {
